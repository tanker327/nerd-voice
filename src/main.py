...
class VoiceApp:
    def __init__(self, master):
        ...
        self.record_button = tk.Button(top_frame, height=8, width=10, text="Record", command=self.toggle_record)
        ...
        self.status_rect = self.status_canvas.create_rectangle(0, 0, 50, 90, fill="green",width=0)
        
        self.play_button = tk.Button(top_right_frame, height=2, width=2, text="Play", command=self.play)
